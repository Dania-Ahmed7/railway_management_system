...
<html>
  ...
  <input type="submit" value="VIEW TRAIN LIST">
</form>

          </div>
          <div class="item">
            <form action="enquiryinsert.php" method="post">
  <input type="submit" value="ENQUIRE">
</form>
          </div>
          <div class="item">
           <form action="bookinsert.php" method="post">
  <input type="submit" value="BOOK A TRAIN TRIP">
</form>
          </div>
          <div class="item">
   <form action="cancelinsert.php" method="post">
  <input type="submit" value="CANCEL A BOOKING">
</form>
          </div>
          <div class="item">
