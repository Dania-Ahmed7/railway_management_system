...
<html>
  ...
  <div style="margin-bottom: 10px;">
    <select id="train_number" name="train_number">
 <option value="" selected>-- Select a train number --</option>
      <option value="1759">1759: Quetta to Karachi</option>
      <option value="1760">1760: Peshawar to Mardan</option>
      <option value="1761">1761: Karachi to Islamabad</option>
      <option value="1762">1762: Rawalpindi to Multan</option>
      <option value="1764">1764: Hyderabad to Sukkur</option>
    </select>
...
<script>
  ...
  // Set the maximum allowed date to seven days from the current date
